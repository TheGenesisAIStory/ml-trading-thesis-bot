...
The maintained notebooks run without TensorFlow/PyTorch. They use bootstrap and AR synthetic-return generators as portable GAN/TimeGAN fallbacks and evaluate distributional similarity.

Artifacts are written to `../data/gans_synthetic_time_series/`.
