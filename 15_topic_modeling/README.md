...
The maintained notebooks use a local financial text corpus and `scikit-learn` topic models. Gensim and pyLDAvis are optional in the original chapter but are not required here; NMF provides a portable pLSA-style fallback and LDA uses sklearn.

Artifacts are written to `../data/topic_modeling/`.
