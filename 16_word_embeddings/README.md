...
The maintained notebooks run without TensorFlow, Gensim, or pretrained vector downloads. They use local financial text, co-occurrence matrices, SVD embeddings, cosine similarity, document vectors, and sklearn sentiment models.

Artifacts are written to `../data/word_embeddings/`.
