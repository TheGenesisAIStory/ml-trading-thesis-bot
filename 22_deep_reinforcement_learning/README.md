...
The maintained notebooks run without Gym/Gymnasium/TensorFlow/PyTorch. They use numpy gridworld value iteration, Q-learning, a reward-curve fallback, and a compact trading Q-learning loop.

Artifacts are written to `../data/deep_reinforcement_learning/`.
