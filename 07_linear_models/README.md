...
The notebooks now use [`linear_model_utils.py`](linear_model_utils.py) and scikit-learn/numpy implementations that run on Python 3.10+ without optional legacy packages such as `statsmodels`, `linearmodels`, `talib`, `alphalens`, or HDF5 stores.

| Notebook | Modern focus |
|---|---|
| [`01_linear_regression_intro.ipynb`](01_linear_regression_intro.ipynb) | OLS with numpy and scikit-learn |
| [`02_fama_macbeth.ipynb`](02_fama_macbeth.ipynb) | Cross-sectional factor regressions |
| [`03_preparing_the_model_data.ipynb`](03_preparing_the_model_data.ipynb) | Panel feature preparation |
| [`04_statistical_inference_of_stock_returns_with_statsmodels.ipynb`](04_statistical_inference_of_stock_returns_with_statsmodels.ipynb) | Portable coefficient diagnostics |
| [`05_predicting_stock_returns_with_linear_regression.ipynb`](05_predicting_stock_returns_with_linear_regression.ipynb) | Ridge/Lasso return prediction |
| [`06_evaluating_signals_using_alphalens.ipynb`](06_evaluating_signals_using_alphalens.ipynb) | Alphalens-style IC and quantile returns without alphalens |
| [`07_logistic_regression_macro_data.ipynb`](07_logistic_regression_macro_data.ipynb) | Logistic classification workflow |
| [`08_predicting_price_movements_with_logistic_regression.ipynb`](08_predicting_price_movements_with_logistic_regression.ipynb) | Price direction prediction |
