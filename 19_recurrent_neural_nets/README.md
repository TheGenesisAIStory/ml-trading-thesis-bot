...
The maintained notebooks run without TensorFlow/Keras recurrent layers or external text downloads. They use fixed lookback windows, sklearn MLP/Ridge models, TF-IDF text classifiers, and local synthetic sequence data.

Artifacts are written to `../data/recurrent_neural_nets/`.
