...
## Modern Alternative Data Catalog

| File | Purpose |
|---|---|
| [`free_finance_ml_sources.py`](free_finance_ml_sources.py) | Curated free/low-friction finance ML source registry |
| [`00_alternative_data_definitive.ipynb`](00_alternative_data_definitive.ipynb) | Executable catalog export and safe alternative-data overview |
| [`requirements.txt`](requirements.txt) | Minimal modern dependencies for this folder |

The modern catalog includes FRED, SEC EDGAR, Yahoo Finance, Stooq, GDELT, Google Trends, Wikipedia Pageviews, OpenInsider, TradingView free, OpenBB, Polymarket, and Stocktwits. It is metadata-first and avoids heavy crawling or scraping.
...
The subfolder [02_earnings_calls](02_earnings_calls) contains the script [sa_selenium](02_earnings_calls/sa_selenium.py) to scrape earnings call transcripts from the [SeekingAlpha](https://www.seekingalpha.com) website.
