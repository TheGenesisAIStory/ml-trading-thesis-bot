...
Modern local integration now centers on the provider registry in [`03_data_providers/api_provider_registry.py`](03_data_providers/api_provider_registry.py), with safe masked credential checks and optional OpenBB credential bridging. See [`03_data_providers/03_integrated_api_provider_registry_definitive.ipynb`](03_data_providers/03_integrated_api_provider_registry_definitive.ipynb) and [`../data/00_data_api_services_catalog_definitive.ipynb`](../data/00_data_api_services_catalog_definitive.ipynb).
