...
The notebooks now use [`ml_process_utils.py`](ml_process_utils.py) and scikit-learn primitives directly instead of optional visualization dependencies such as Yellowbrick. They are designed to run on Python 3.10+ with deterministic synthetic datasets.

| Notebook | Modern focus |
|---|---|
| [`01_machine_learning_workflow.ipynb`](01_machine_learning_workflow.ipynb) | Train/test workflow, pipeline, cross-validation |
| [`02_mutual_information.ipynb`](02_mutual_information.ipynb) | Mutual information for regression and classification features |
| [`03_bias_variance.ipynb`](03_bias_variance.ipynb) | Bias/variance via learning and validation curves |
