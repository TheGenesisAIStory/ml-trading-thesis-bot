...
The maintained notebooks run without spaCy, TextBlob, NLTK, VADER, Twitter, or Yelp downloads. They use a compact local financial corpus, regex tokenization, TF-IDF, Naive Bayes, logistic regression, and transparent lexicon sentiment.

Artifacts are written to `../data/text_data/`.
