...
The maintained notebooks run without TensorFlow, PyTorch, OpenCV, or external image downloads. They use scipy filters, sklearn digits, MLP/logistic models, PCA bottleneck features, and synthetic trading-image examples.

Artifacts are written to `../data/convolutional_neural_nets/`.
