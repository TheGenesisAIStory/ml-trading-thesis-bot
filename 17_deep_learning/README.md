...
The maintained notebooks run without TensorFlow, Keras, PyTorch, Zipline, or GPU setup. They use `scikit-learn` MLP models as portable neural-network fallbacks plus vectorized signal evaluation.

Artifacts are written to `../data/deep_learning/`.
