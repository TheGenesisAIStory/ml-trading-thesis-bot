...
The maintained notebooks run without TensorFlow/Keras or Alphalens. They use PCA/MLP autoencoder fallbacks, denoising examples, latent factors, and a compact conditional return model.

Artifacts are written to `../data/autoencoders/`.
