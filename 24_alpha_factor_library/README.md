...
The maintained notebooks run without TA-Lib, SHAP, or Alphalens. They compute representative pandas factors, compact formulaic alphas, random-forest importance, and quantile diagnostics.

Artifacts are written to `../data/alpha_factor_library/`.
