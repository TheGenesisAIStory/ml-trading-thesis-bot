...
The executable notebooks now use `ml4t_workflow_utils.py` for vectorized signals, walk-forward ML predictions, and portfolio diagnostics without requiring deprecated Backtrader/Zipline runtimes.

| Notebook | Modern focus |
|---|---|
| `02_vectorized_backtest.ipynb` | Vectorized signal backtest |
| `03_backtesting_with_backtrader.ipynb` | Backtrader-style performance summary without Backtrader runtime |
| `04_ml4t_workflow_with_zipline/02_backtesting_with_zipline.ipynb` | Zipline-style backtest table without Zipline runtime |
| `04_ml4t_workflow_with_zipline/03_ml4t_with_zipline.ipynb` | Walk-forward ML workflow and long/short strategy diagnostics |
